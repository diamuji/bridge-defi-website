        ...
        <div>
            ...
            <div class="grid grid-cols-3 gap-4">
                ...
                <div className="col-span-2">
                    <b>{user.confirmed ? <span className="text-teal-500">true</span> : 'false'}</b>
                    {!user.confirmed && (
                        <button
                ...
                <div>Admin:</div>
                <div className="col-span-2">
                    <b>{user.isAdmin ? <span className="text-teal-500">true</span> : 'false'}</b>
                    {!user.isAdmin && (
                        <button
                            className="btn text-white bg-teal-500 hover:bg-teal-400 py-2 px-3 text-xs uppercase ml-4 font-bold"
                            onClick={() => makeAdmin()}
                ...
                <div>Verified:</div>
                <div className="col-span-2">
                    <b>{user.verified ? <span className="text-teal-500">true</span> : 'false'}</b>
                    {!user.verified && (
                        <button
                            className="btn text-white bg-teal-500 hover:bg-teal-400 py-2 px-3 text-xs uppercase ml-4 font-bold"
                            onClick={() => verify()}
