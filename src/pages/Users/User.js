    ...
    return (
        <div>
            <div className="flex flex-row align-middle mb-5">
                <a onClick={onDeselect} className="block cursor-pointer mr-3">
            ...
            <div className="bg-white shadow-lg rounded-sm border border-gray-200 text-gray-600 p-5">
