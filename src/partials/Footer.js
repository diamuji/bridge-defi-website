          ...
          <div className="md:flex md:items-center md:justify-between">
            {/* Social links 
                <ul className="flex mb-4 md:order-2 md:ml-4 md:mb-0">
                    <li>
                        <a className="flex justify-center items-center text-white bg-lightblue-100 dark:text-lightblue-100 dark:bg-gray-800 hover:underline hover:bg-lightblue-200 rounded-full transition duration-150 ease-in-out" href="#0" aria-label="Twitter">
                    ...
                    <li className="ml-4">
                        <a className="flex justify-center items-center text-white bg-lightblue-100 dark:text-lightblue-100 dark:bg-gray-800 hover:underline hover:bg-lightblue-200 rounded-full transition duration-150 ease-in-out" href="#0" aria-label="Github">
                            <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li className="ml-4">
                        <a className="flex justify-center items-center text-white bg-lightblue-100 dark:text-lightblue-100 dark:bg-gray-800 hover:underline hover:bg-lightblue-200 rounded-full transition duration-150 ease-in-out" href="#0" aria-label="Facebook">
                            <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li className="ml-4">
                        <a className="flex justify-center items-center text-white bg-lightblue-100 dark:text-lightblue-100 dark:bg-gray-800 hover:underline hover:bg-lightblue-200 rounded-full transition duration-150 ease-in-out" href="#0" aria-label="Instagram">
                            <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li className="ml-4">
                        <a className="flex justify-center items-center text-white bg-lightblue-100 dark:text-lightblue-100 dark:bg-gray-800 hover:underline hover:bg-lightblue-200 rounded-full transition duration-150 ease-in-out" href="#0" aria-label="Linkedin">
                            <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
